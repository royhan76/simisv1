                            ...
                            <div class="row">
                                <div class="col-md-4 mt-3">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="tempat_lahir form-control input-full "
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input id="inputFloatingLabel2" id="tgl_lahir" name="tgl_lahir" type="date"
                                            class="form-control input-full"  placeholder="tanggal lahir">
                                    </div>
                                    {{-- pendidikan_id --}}
                                    <div class="form-group ">
                                ...
                                <div class="col-md-4 mt-3">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="khos form-control input-full " name="khos"></select>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="status_santri form-control input-full "
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="propinsi_id form-control input-full " name="propinsi_id"
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="kabupaten_id form-control input-full "
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="kecamatan_id form-control input-full "
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="kelurahan_id form-control input-full "
