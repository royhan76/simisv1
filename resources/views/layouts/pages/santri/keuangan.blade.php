            ...
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/admin/santri/update/'. $santri->santri_id) }}" method="POST" id="form_edit" class="form_edit"  enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-inline">
                                        <div class="btn-group" style="margin-top: 20px;">
                                            <a id="btn-batal" href="{{url('admin/santri')}}"
